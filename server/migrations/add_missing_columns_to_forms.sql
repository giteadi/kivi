...
-- Adds folder_id and client_id columns for form organization
...
SET @sql = IF(@exists = 0,
              'ALTER TABLE forms ADD COLUMN folder_id INT NULL DEFAULT NULL',
...
SET @sql2 = IF(@exists2 = 0,
               'ALTER TABLE forms ADD COLUMN client_id INT NULL DEFAULT NULL',
...
SET @sql3 = IF(@idx_exists = 0,
               ...
               'SELECT "idx_folder_id already exists" as message');
...
SET @sql4 = IF(@idx_exists2 = 0,
               ...
               'SELECT "idx_client_id already exists" as message');

PREPARE stmt4 FROM @sql4;
EXECUTE stmt4;
DEALLOCATE PREPARE stmt4;

SELECT 'Migration completed: folder_id and client_id columns added to forms table' as status;
