...
const ServiceCreateForm = ({ onSave, onCancel }) => {
  ...
  // Fetch therapists when centre changes
  useEffect(() => {
  ...
  const handleCentreChange = (centreName) => {
    ...
    setFormData(prev => ({
      ...
      therapistId: '' // Reset therapist when centre changes
    }));
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      const serviceData = {
        programme_id: formData.name.substring(0, 2).toUpperCase(),
        name: formData.name,
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    disabled={!formData.centreId || loadingTherapists}
                  ...
                  >
                    ...
                    {therapists.map((therapist) => (
                      <option key={therapist.id} value={therapist.id}>
                        {therapist.first_name} {therapist.last_name} - {therapist.specialty} ({therapist.employee_id})
                      </option>
                    ))}
                  </select>
                </div>
