            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-[#2c2c2e] border-b border-gray-200 dark:border-gray-700">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Center</th>
          ...
          >
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Delete Therapy?</h3>
