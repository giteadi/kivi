...
const SimpleWJIVCogExtTemplate = ({ onBack }) => {
  const [formData, setFormData] = useState({
    title: "WJ-IV COG – STANDARD & EXTENDED BATTERY",
    
    description: "The Woodcock-Johnson IV Tests of Cognitive Abilities (WJ-IV COG) Extended Battery provides a comprehensive assessment of cognitive abilities including additional tests for in-depth evaluation of specific cognitive processes and executive functions.",
    ...
    // All clusters from Standard + Extended
    gia: { name: "General Intellectual Ability (GIA-Ext)", score: "", rpi: "", descriptor: "" },
    ...
    gwmSubtests: [
      ...
      { name: "Object-Number Sequencing (Ext)", score: "", rpi: "", descriptor: "" }
    ],
    ...
    gsSubtests: [
      ...
      { name: "Number-Pattern Matching (Ext)", score: "", rpi: "", descriptor: "" }
    ],
    ...
    gaSubtests: [
      ...
      { name: "Auditory Attention (Ext)", score: "", rpi: "", descriptor: "" }
    ],
    ...
    glrSubtests: [
      ...
      { name: "Memory for Names (Ext)", score: "", rpi: "", descriptor: "" }
    ],
    ...
    gvSubtests: [
      ...
      { name: "Picture Patterns (Ext)", score: "", rpi: "", descriptor: "" }
    ],
    
    // Extended Battery Additional Clusters
    gfQuantCluster: { name: "Quantitative Reasoning (Gf-Quant)", score: "", rpi: "", descriptor: "" },
    gfQuantSubtests: [
      { name: "Number Series", score: "", rpi: "", descriptor: "" },
      { name: "Number Matrices (Ext)", score: "", rpi: "", descriptor: "" }
    ],
    
    gwmExtCluster: { name: "Working Memory Extended (Gwm-Ext)", score: "", rpi: "", descriptor: "" },
    gwmExtSubtests: [
      { name: "Numbers Reversed", score: "", rpi: "", descriptor: "" },
      { name: "Object-Number Sequencing", score: "", rpi: "", descriptor: "" },
      { name: "Memory for Words (Ext)", score: "", rpi: "", descriptor: "" }
    ],
    
    execFunctionCluster: { name: "Executive Functions (EXT)", score: "", rpi: "", descriptor: "" },
    execFunctionSubtests: [
      { name: "Inhibition (Ext)", score: "", rpi: "", descriptor: "" },
      { name: "Switching (Ext)", score: "", rpi: "", descriptor: "" },
      { name: "Planning (Ext)", score: "", rpi: "", descriptor: "" }
    ],
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>WJ-IV COG Extended</title>
          <style>
            ...
            .extended-header { background-color: #666; color: white; font-size: 9pt; font-weight: bold; padding: 3px; text-align: center; margin: 10px 0; }
        ...
        <body>
          <div class="report-box">
            ...
            <!-- STANDARD BATTERY -->
            <div class="section-header">STANDARD BATTERY</div>
            ...
            <table>
              ...
              <!-- Standard Clusters -->
              ${renderPrintCluster(formData.gcCluster, formData.gcSubtests)}
              ${renderPrintCluster(formData.gfCluster, formData.gfSubtests)}
              ${renderPrintCluster(formData.gwmCluster, formData.gwmSubtests)}
              ${renderPrintCluster(formData.gsCluster, formData.gsSubtests)}
              ${renderPrintCluster(formData.gaCluster, formData.gaSubtests)}
              ${renderPrintCluster(formData.glrCluster, formData.glrSubtests)}
              ${renderPrintCluster(formData.gvCluster, formData.gvSubtests)}
            </table>
            
            <!-- EXTENDED BATTERY -->
            <div class="extended-header">EXTENDED BATTERY - ADDITIONAL TESTS</div>
            
            <table>
              <tr>
                <th>Extended Cluster/Subtest</th>
                <th>Standard Score</th>
                <th>RPI</th>
                <th>Descriptor</th>
              </tr>
              
              ${renderPrintCluster(formData.gfQuantCluster, formData.gfQuantSubtests)}
              ${renderPrintCluster(formData.gwmExtCluster, formData.gwmExtSubtests)}
              ${renderPrintCluster(formData.execFunctionCluster, formData.execFunctionSubtests)}
            </table>
      ...
      <div className="bg-white shadow-sm border-b sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-semibold text-gray-800">WJ-IV COG Extended</h1>
          </div>
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          <div ref={printRef} className="p-8" style={{ fontFamily: 'Times New Roman, Times, serif' }}>
            ...
            <div style={{ border: '1px solid #000', padding: '20px', maxWidth: '750px' }}>
              ...
              {/* STANDARD BATTERY */}
              <div className="mb-2 bg-gray-200 px-2 py-1 font-bold" style={{ fontSize: '10pt' }}>STANDARD BATTERY</div>
              ...
              {/* EXTENDED BATTERY */}
              <div className="mb-2 bg-gray-600 text-white px-2 py-1 font-bold text-center" style={{ fontSize: '9pt' }}>EXTENDED BATTERY - ADDITIONAL TESTS</div>
              
              <table className="w-full border-collapse border border-black mb-4">
                <thead>
                  <tr className="bg-gray-300">
                    <th className="border border-black px-2 py-1 text-left font-bold text-xs" style={{ width: '40%' }}>Extended Cluster/Subtest</th>
                    <th className="border border-black px-2 py-1 text-center font-bold text-xs">Standard Score</th>
                    <th className="border border-black px-2 py-1 text-center font-bold text-xs">RPI</th>
                    <th className="border border-black px-2 py-1 text-center font-bold text-xs">Descriptor</th>
                  </tr>
                ...
                <tbody>
                  {renderClusterSection('gfQuantCluster', 'gfQuantSubtests')}
                  {renderClusterSection('gwmExtCluster', 'gwmExtSubtests')}
                  {renderClusterSection('execFunctionCluster', 'execFunctionSubtests')}
                </tbody>
              </table>
...
export default SimpleWJIVCogExtTemplate;
