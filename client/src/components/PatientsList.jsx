...
const PatientsList = ({ onViewPatient, onEditPatient, onDeletePatient, onCreateNewPatient }) => {
  ...
  const patients = [
    ...
    },
    {
      ...
      name: 'Larry Lopez',
      initials: 'LL',
      email: 'kjaggi+patient@mindsalelearning.com',
      phone: '+1 0286649878',
      clinic: 'Clinic Kjaggi',
      clinicColor: 'bg-blue-100 text-blue-800',
    ...
    },
    {
      ...
      name: 'Raymond Rogers',
      initials: 'RR',
      email: 'kjaggi+patient7@mindsalelearning.com',
      phone: '+1 4079677682',
    ...
    <div className="lg:ml-64 min-h-screen bg-gray-50">
      <div className="p-4 lg:p-6">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-6">
          ...
          <span>Patients</span>
          <span className="mx-2">›</span>
          <span className="text-gray-800">All Patients</span>
        </div>
        ...
        >
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border">
            <div className="text-2xl font-bold text-purple-600">
              {new Set(patients.map(p => p.clinic)).size}
            </div>
