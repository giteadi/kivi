...
const WJAchTemplate = ({
  ...
  const getDescriptor = (standardScore) => {
    if (standardScore >= 121) return 'Very Superior';
    if (standardScore >= 111) return 'Superior';
    if (standardScore >= 90) return 'High Average';
    if (standardScore >= 80) return 'Average';
    if (standardScore >= 70) return 'Low Average';
    return 'Very Poor';
  };

  const getScoreColor = (standardScore) => {
    if (standardScore >= 121) return 'text-purple-600 bg-purple-50';
    if (standardScore >= 111) return 'text-blue-600 bg-blue-50';
    if (standardScore >= 90) return 'text-green-600 bg-green-50';
    if (standardScore >= 80) return 'text-yellow-600 bg-yellow-50';
    if (standardScore >= 70) return 'text-orange-600 bg-orange-50';
        ...
        <div className="space-y-6">
          <div>
            ...
            <textarea
              ...
              placeholder="Enter your interpretation of WJ-Ach results..."
            />
          </div>
